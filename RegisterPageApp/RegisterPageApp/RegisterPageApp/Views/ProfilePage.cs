...
namespace RegisterPageApp.Views
{
    public class ProfilePage : ContentPage
    {
        public ProfilePage(User user)
        {
            ...
            formattedString.Spans.Add(new Span { Text = "TheCodeMonsters", TextColor = Color.Orange, FontSize = 24,
            ...
            Content = new StackLayout
            {
                Children =
                {
                    ...
                    new Label{Text=$"Email: {user.Email}", TextColor=Color.Black, FontSize=20},
                    new Label{Text=$"Phone: {user.Phone}", TextColor=Color.Black, FontSize=20},
                }
            };
        }
    }
